export default {
  common: {
    ...
    logout: "خروج",
    tip: "نکته",
    logintip: "لطفا اول وارد شوید",
    expect: "منتظر انتظار باشید!",
    delete: "آیا تأیید می کنید که حذف شود?",
    nodata: "بدون اطلاعات",
    set: "تنظیم",
    update: "تغییر",
    slogan: "بهترین پلتفرم مورد اعتماد برای تجارت FIAT رمز ارز مجازی و    ",
    subslogan:
      "ما به افراد تازه وارد و حرفه ای امکان خرید و فروش انواع دارایی های دیجیتال را در یک بستر صرافی بسیار امن و دارای حمایت بیمه ارائه می دهیم.",
    more: "بیشتر",
    please: "لطفا",
    nodata: "ثبت نشده است",
    pleaseselect: "لنتخاب",
    searchplaceholder: "نماد سکه را وارد کنید ...",
    searchplaceholderswap: "نماد مبادله را وارد کنید ...",
    loading: "بارگذاری...",
    close: "بستن",
    ok: "خوب",
    fillComplete: "لطفا اطلاعات کامل را پر کنید",
  },
  header: {
    index: "خانه",
    otc: "فرابورس",
    ...
    ucenter: "حساب",
    service: "اعلامیه",
    downloadapp: "کد را برای بارگیری و نصب اسکن کنید",
    appdownlaod: "بارگیری برنامه",
    usercenter: "مرکز کاربری",
    helpcenter: "مرکز کمک",
    aboutus: "در باره",
    partner: "شریک",
    bzb: "BZB ECO",
    assetmanage: "دارایی، مالیه، سرمایه گذاری",
    trademanage: "تبادل",
    activity: "رعد و برق",
    lab: "آزمایشگاه حرفه ای تخصصی",
    ctc: "تبادل C2C",
    labdetail: "آزمایشگاه صاعقه EXCOINCIAL",
    invite: "تبلیغ شریک",
    whitepaper: "کاغذ سفید",
    scandownload: "بارگیری برنامه",
    innovationmanage: "نوآوری",
    swap1: "مبادله (PRO)",
    swap2: "مبادله (سابق)",
    swap3: "CFD",
    swap4: "دومین",
    cexchange: "تبادل کوئک",
    option: "قرارداد گزینه",
    news: "اخبار",
  },
  sectionPage: {
    ...
    brandTitle: "About EXCOINCIAL Pro",
    brandDetail: "Honest  |  Fair  |  Enthusiasm  |  Open",
    brandDesc1:
      "EXCOINCIAL Pro was founded by a group of early Bitcoin participants and geeks. The core members of the team are from well-known enterprises such as Google, Microsoft, Alibaba, Tencent and so on. It has deep research and development strength and rich experience in Internet product operation.",
    brandDesc2:
      "EXCOINCIAL Pro is located in the basic service provider of block chain, dedicated to providing high-quality encrypted assets trading platform for global users, adhering to the basic principle of “DO NOT BE EVIL”, upholding honest, fair and enthusiastic service to customers, and welcoming all partners/projects that are beneficial to the fundamental interests of users with an open attitude.",
    gettingstart: "HOT | Beginner's Guide",
    officialstart: "EXCOINCIAL Pro Official Customer Service",
  ...
  nav: {
    PlatformTrading: "تجارت پلت فرم",
    PlatformSecurity: "امنیت سیستم عامل",
    Platformstrength: "قدرت سکو",
    NewsCenter: "مرکز خبر",
    PostAdnow: "هم اکنون آگهی ارسال کنید",
  },
  progress: {
    already: "باید حفاری کنید",
    total: "مقدار سنگ معدن قابل حفر 6 میلیارد BHB",
  },
  service: {
    USDT: "USDT",
    BTC: "BTC",
  ...
  exchange: {
    ...
    market: "Markets",
    favorite: "Marked",
    do_favorite: "Added Favor",
    cancel_favorite: "Removed Favor",
    type: "Type",
    ...
    curdelegation: "Open Order",
    hisdelegation: "History Order",
  ...
  ctc: {
    ...
    desc: "Crypto assets are managed by EXCOINCIAL Pro, and the acceptor provides exchange services for exchange.",
    buyin: "Buy",
    sell: "Sell",
    buyprice: "Buy Price",
    sellprice: "Sell Price",
  ...
  cexchange: {
    title: "Quick Exchange Activity",
    desc: "Coin ● One-click ● Profit everyday",
    ...
    confirmmsg: "Are you sure to exchange LTC?",
    ok: "OK",
    cancel: "Cancel",
  },
  option: {
  ...
  otc: {
    ...
    publishad: {
      ...
      submittip3: "Please set your Fund Password",
  ...
  activity: {
    ...
    attentiontxt4:
      "* The right of final interpretation of this activity belongs to the official ownership of EXCOINCIAL Pro.",
  ...
  invite: {
    ...
    ruleprofile1:
      "[Promotion Partner] is the highest proportion of online Commission return and the longest time of commission return (maximum lifetime commission). Promoters who make corresponding efforts can become real platform ‘partners’ and enjoy the dividend of growing together with EXCOINCIAL Pro trading platform. Detailed rules are as follows:",
    ruleprofile2: "",
    ruleprofile3: "",
    ruleprofile4: "",
    ruletext1:
      "1、In order to preach the concept of digital assets and expand the scale of users, EXCOINCIAL Pro launched the “Promotion Partner” program, which is effective for a long time.",
    ruletext2:
    ...
    ruletext11:
      "11、The right of final interpretation of this activity belongs to EXCOINCIAL Pro.",
    ...
    thanks: "Thank you for supporting EXCOINCIAL Pro！",
    headertip:
    ...
    pt_tips:
      "If you have a good idea, please send an email to promotion@bizzan.pro, with a reward after adoption.！",
    ...
    pt_card_rule2:
      "2. Free gift cards are limited to one copy per user. Free gift cards issued by the EXCOINCIAL Pro government are limited to one for each user. Even if different users receive free gift cards with different exchange codes, only one can be exchanged. Custom gift cards are not subject to this restriction.",
    pt_card_rule3:
    ...
    pt_card_rule6:
      "6. The right of final interpretation of free gift cards belongs to WWW.EXCOINCIAL.COM.",
    pt_card_day: "Days",
  ...
  uc: {
    ...
    finance: {
      ...
      withdraw: {
        ...
        msg3: "The minimum withdrawal number of coins is",
        msg4: "currency",
        msg5: "In order to ensure the security of funds, when your account security policy changes, passwords are changed, and you use the new address to withdraw coins, we will conduct a manual audit of the coins. Please be patient and wait for our email.",
    ...
    member: {
      ...
      assets: "Finance",
      exchange: "Exchange",
      curdelegate: "Current Order",
      hisdelegate: "History Order",
      otc: "OTC",
    },
    order: {
    ...
    safe: {
      ...
      verifiedtip:
        "To protect your account security, please complete real-name certification.",
      realname: "Full Name",
      idcard: "ID #",
      upload: "Upload",
      ...
      bindemailtip: "Please bind your email first!",
      ...
      idcard_verifymsg1:
        "1. The file is less than 2 MB.The information on the document should be clearly visible, no modifications in the document or cover by the foreign objects is allowed, and the document number and name should be visible.",
      idcard_verifymsg2:
    ...
    identity: {
      ...
      apply: "Apply to become merchant",
      become:
        "Become EXCOINCIAL Pro Certified Business and enjoy more transaction privileges",
      zhusnhu:
      ...
      tijiaosuc:
        "Congratulations, Your merchant certification has been verified.",
      tijiaofail: "I'm sorry! Your merchant's certification has been declined",
      zhuxiaotijiao:
        "Your merchant cancellation application has been submitted",
      shenhefail:
        "Your merchant cancellation application has not been approved",
      shenhesuc: "Your merchant cancellation application has been approved",
      shangjiazhuxiao: "Merchant cancellation",
      shenagain: "Review",
      shenheshibai: "Audit Failed",
      sheqinggain: "To apply for",
      reason: "Reason",
      shenqingtuibao: "Apply for merchant cancellation",
      getquan: "You have the following permissions",
      read: "I read and agree",
      lijishenqing: "Apply immediately",
      tips: "Confirm cancellation",
      wufachexiao:
      ...
      second: {
        line: "How to apply for Merchant?",
        step1: "Step 1:Prepare business application requirements as required",
        ...
        step2c:
          "To complete the business certification you need to be filled in and upload all the requirementsu. Click submit for approval.",
        step3: "Step 3: Data audit",
        stepc:
          "We'll be reviewing your applications for the next 3 to 5 business days, please keep updated, After the approval, you can now BUY/SELL Cryptocurrency",
  ...
  cms: {
    ...
    download: "Download",
    downloadslogan: "EXCOINCIAL Pro APP - Trade everywhere.",
  },
  description: {
    title1: "Security",
    title2: "24H Service",
    ...
    aboutdesc1:
      "WWW.EXCOINCIAL.COM is a leading digital asset trading platform in the world, registered in the Cayman Islands, with a core operating team in Hong Kong. The core members of WWW.EXCOINCIAL.COM come from top Internet and financial companies. Most of them are deep believers in Bitcoin and block chains. We are convinced that block chains will change the traditional monopolistic financial system and build a more democratic and autonomous social structure.",
    aboutdesc2:
      "WWW.EXCOINCIAL.COM platform has a professional financial-level trading architecture, a self-developed high concurrent memory matching trading engine. The platform uses a full-cold rechargeable wallet system + multiple signatures + high-protection DDOS attack system and other trading architecture to ensure customer asset security.",
    aboutdesc3:
      "In order to let customers better grasp the investment opportunities, WWW.EXCOINCIAL.COM adopts flat management in customer service department, and establishes an extremely fast service response mechanism. The asset customer service manager is on-line 7*24H all the year round, providing customers with services such as recharge and cash of assets, and ensuring that customers complete recharge in 25 minutes.",
    aboutdesc4:
      "WWW.EXCOINCIAL.COM strictly screens high-quality projects and provides secure and stable asset hosting services. WWW.EXCOINCIAL.COM upholds the concept of “honesty, justice, enthusiasm and openness”, and strives to create a safe, reliable, efficient and friendly ultimate exchange for users.",
    aboutdesc5:
    ...
    apply: "Board Apply",
    coop: "Cooperation",
    community: "EXCOINCIAL Pro Community",
    wechat: "Wechat",
    addwechat:
      "Add 'EXCOINCIAL' as Wechat friends and then enter Wechat community",
    weibo: "Weibo",
    twitter: "Twitter",
    biyong: "Biyong",
    telegram: "Telegram",
  ...
  footer: {
    wechatkefu: "سرویس Wechat",
    notice: "اعلامیه",
    Slogon: "بهترین صرافی ارز رمزنگاری شده",
    AddressCom: "هر ادرسی",
    Profile: "مشخصات",
    AboutUs: "درباره ما",
    JOINROM: "به ما بپیوند",
    biyong: "کشف",
    ContactUS: "با ما تماس بگیرید",
    LINKSs: "پیوندها",
    HELPSS: "کمک",
    BEGINNERCOURSE: "یک دوره مبتدی",
    Recharge: "راهنمای شارژ",
    Trade: "راهنمای تجارت",
    Explain: "توضیح",
    Fees: "هزینه ها",
    Service: "خط مشی خدمات",
    Legal: "سیاست حقوقی",
    Wechat: "خدمات مشتری Wechat",
    Beginner: "راهنمای مبتدیان",
    FAQ: "سالات متداول",
    Disclaimer: "سلب مسئولیت",
    Privacy: "سیاست حفظ حریم خصوصی",
    Conditions: "شرایط",
    About: "درباره BZB",
    Service: "صندوق پستی سرویس",
    Cooperation: "مشارکت",
    Market: "برنامه بازار",
    Exchange: "راهنمای تبادل",
    Coins: "اطلاعات کوین",
    Report: "گزارش",
    apidoc: "Api Doc",
    ComingSoon: "به زودی",
  ...
  index: {
    circulation: "گردش صندوق ایمنی و توسعه",
    hourEth: "درآمد انباشته امروز توزیع می شود",
    yesterdayEth: "درآمد انباشته در روز گذشته توزیع می شود",
    yesterday: "خروجی استخراج روز قبل:",
    bhbTotal: "BHB جریان کل",
    bhbSecond: "BHB گردش بازار دو سطح",
    checkMineprinciple: "مشاهده اصل استخراج",
    checkFlowVolum: "بازرسی از ترافیک",
    checkLockPosition: "وضعیت قفل را بررسی کنید",
    BHBregister: "EXCOINCIAL ثبت نام حساب حرفه ای",
    tibi: "زمان و محدودیت پرداخت وجه به صورتحساب",
    line_plane:
      "اعلامیه در مورد برنامه آنلاین BHB ، تیراژ و بازپرداخت هزینه خدمات",
    fenpeijizhi: "شرح مکانیسم توزیع درآمد EXCOINCIAL Pro",
    jiangli_jihua: "دعوت از طرح جایزه استخراج",
    friend_fanhuan:
      "دوستان را دعوت کنید ، هزینه اضافی کسب کنید و بازپرداخت کنید",
  },
  plate: {
    title: "Platform income distribution scheme（BHB Holder's equity）",
    content1:
      "As described in the white paper, EXCOINCIAL Pro will take up 80% of the platform (after deduct Taxes and fees )The income is allocated to BHB holders, and 20% of revenue is used to support R & D and operation of the platform.",
    content2:
