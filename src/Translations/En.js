export default {
  common: {
    ...
    set: "Set",
    update: "Modify",
    slogan: "THE MOST TRUSTED PLATFORM FOR TRADING FIAT & CRYPTOCURRENCIES",
    subslogan:
      "We offer newbies and professionals the possibility to trade a variety of digital assets on a highly secure, insurance-backed Exchange platform.",
    more: "More",
    please: "Please",
    nodata: "No Records",
    pleaseselect: "Select",
  ...
  header: {
    ...
    activity: "Lightning",
    lab: "EXCOINCIAL Pro Lab",
    ctc: "C2C Exchange",
    labdetail: "EXCOINCIAL Pro Lightning Lab",
  ...
  footer: {
    ...
    notice: "Announcement",
    gsmc: "The Best Cryptocurrency Exchange",
  ...
  index: {
    ...
    BHBregister: "EXCOINCIAL Pro account registration",
    ...
    fenpeijizhi:
      "A description of the EXCOINCIAL Pro income distribution mechanism",
